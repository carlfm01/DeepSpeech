...
namespace DeepSpeechClient
{
    ...
    public static class LpcNetNativeImp
    {
        ...
        [DllImport(@"C:\Users\Carlos\_bazel_Carlos\lafotith\execroot\org_tensorflow\bazel-out\x64_windows-opt\bin\native_client\lpcnet.dll", CallingConvention = CallingConvention.Cdecl, EntryPoint = "synthesize_features")]
