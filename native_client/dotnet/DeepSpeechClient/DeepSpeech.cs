...
namespace DeepSpeechClient
{
    ...
    public class DeepSpeech : IDeepSpeech
    {
        ...
        {
            NativeImp.DS_FeedAudioContent(stream.StreamingStatePP, aBuffer, aBufferSize);
        }
        ...
        {
            return NativeImp.DS_FinishStream(stream.StreamingStatePP).PtrToString();
        }
        ...
        {
            return NativeImp.DS_FinishStreamWithMetadata(stream.StreamingStatePP).PtrToMetadata();
        }
        ...
        {
            return NativeImp.DS_IntermediateDecode(stream.StreamingStatePP);
        }
        ...
        {
            NativeImp.DS_FreeStream(stream.StreamingStatePP);
            stream.StreamingStatePP = null;
        }
